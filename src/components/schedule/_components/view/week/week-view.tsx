...
import { AnimatePresence, motion, HTMLMotionProps } from "framer-motion"; // Import Framer Motion
...
// Strongly-typed MotionDiv alias so TS accepts className & HTML motion props
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex ml-auto gap-3">
          {prevButton ? (
            ...
            <Button variant="outline" className={cn(classNames?.prev, 'text-slate-900')} onClick={handlePrevWeek}>
              <ArrowLeft />
              Prev
            </Button>
          )}
          {nextButton ? (
            ...
            <Button variant="outline" className={cn(classNames?.next, 'text-slate-900')} onClick={handleNextWeek}>
              Next
              <ArrowRight />
            </Button>
          )}
      ...
      <AnimatePresence initial={false} custom={direction} mode="wait">
        {/* Use the top-level MotionDiv for consistent typing and props support */}
        <MotionDiv
                              ...
                              <div className="flex flex-col space-y-4 p-4">
                                ...
                                {dayEvents && dayEvents.length > 0 ? (
                                  <div className="space-y-4">
                                    ...
                                    {/* Event list removed per UX request */}
                                  </div>
                                ) : (
                ...
                return (
                  ...
                  >
                      ...
                      {visibleEvents?.map((event, eventIndex) => {
                        ...
                        return (
                          <MotionDiv
                            ...
                            className="absolute transition-all duration-300 z-50 block"
                    ...
                    {Array.from({ length: 24 }, (_, hourIndex) => (
                      ...
                      >
                        <div className="absolute bg-black/6 z-40 flex items-center justify-center text-xs opacity-0 transition duration-250 hover:opacity-100 w-full h-full pointer-events-none">
                              Add Event
                            </div>
                      </div>
                    ))}
