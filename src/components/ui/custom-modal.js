...
export default function CustomModal({ title, children }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-[520px] cozy rounded-md shadow-2xl ring-1 ring-white/6 overflow-visible max-h-[90vh] bg-white dark:bg-slate-900 dark:ring-white/6">
        ...
        <div className="px-6 pb-6 text-slate-700 dark:text-slate-300">{children}</div>
